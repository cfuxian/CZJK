...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "nLEaXaSFND1PFwcU6KEWsU-KDuRDIXVyOU6QKAvo";
    private static final String SECRETKEY = "tv749Pg6zpqzw2hwSpYcSXO6atoSX9XefUPvf557";
    private static final String BUCKET = "cfuxian";
    //外链接域名
    public static final String DOMAIN= "http://qh024ju0j.hn-bkt.clouddn.com/";
